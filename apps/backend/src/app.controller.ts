...
export class AppController {
  ...
  @Put('suppliers/products/:id/activate') async supplierProductActivate(@Req() req: Request, @Param('id') id: string) { const u = await this.auth(req); this.service.requireRole(u, ['supplier']); return this.service.setSupplierProductActive(u.id, id); }
